export const COMPANY = {
  ...
  logo: "https://customer-assets-jt897jd0.emergentagent.net/job_mdot-it-premium-1/artifacts/0kka1gkb_image.png",
...
export const NAV = [
  ...
  { label: "About", to: "/about" },
  {
    ...
    to: "/products",
    children: [
      { label: "Networking", to: "/products?cat=Networking" },
      { label: "Servers", to: "/products?cat=Servers" },
      { label: "Storage", to: "/products?cat=Storage" },
      { label: "Workstations", to: "/products?cat=Workstations" },
      { label: "Laptops", to: "/products?cat=Laptops" },
      { label: "Security", to: "/products?cat=Security" },
    ],
  },
