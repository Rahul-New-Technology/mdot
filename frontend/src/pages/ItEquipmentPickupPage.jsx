...
import { PhoneCall, ArrowUpRight, Truck, Laptop, Monitor, Server, Network, HardDrive, Cpu } from "lucide-react";
import { Link } from "react-router-dom";
import { COMPANY } from "../data/site";
import { trackGoogleAdsPhoneConversion } from "../utils/googleAdsTracking";

export default function ItEquipmentPickupPage() {
  ...
  return (
    <PageShell
      ...
      title="IT Equipment Pickup & Collection Service"
      description="Have a large quantity of old or surplus IT equipment at your office? M DOT IT SOLUZIONE can assist businesses with IT equipment collection and pickup for eligible buyback and disposal requirements."
      imageUrl="https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?crop=entropy&cs=srgb&fm=jpg&q=85"
      customActions={customActions}
      quickContact={quickContact}
    >
      <section className="bg-white section-pad">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8">
          <SectionHeader eyebrow="01 · Equipment We Collect" title={<>Pickup Services</>} />
          
          <Reveal>
            <div className="mt-12 max-w-3xl mx-auto">
              <p className="text-[#2E3440]/70 text-lg leading-relaxed mb-8">
                Our team can discuss the equipment, quantity and location before arranging the appropriate collection process.
              </p>
            </div>
          </Reveal>
      ...
      <section className="bg-[#071B3B] text-white section-pad">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 text-center">
          <Reveal>
            <h2 className="font-display text-3xl md:text-4xl font-semibold mb-6">Have IT equipment ready for pickup?</h2>
            <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
              Contact M DOT IT SOLUZIONE to schedule collection of your IT equipment.
            </p>
            <a
              href={`tel:${COMPANY.phoneRaw}`}
